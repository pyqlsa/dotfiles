...
const SEARXNG_QUALIFIED_TOOL_NAME = "local:pi-tools:searxng_search";
const WEB_SCRAPE_QUALIFIED_TOOL_NAME = "local:pi-tools:web_scrape";
          ...
          content: [
            {
              ...
              text:
                ...
                `Please set it in your settings.json (under 'packageSettings.tools.${SEARXNG_QUALIFIED_TOOL_NAME}.baseUrl').`,
            },
          ],
